...
var defaultNodeRenderers = (_a = {},
    ...
    _a[richTextTypes_es5_1.TABLE] = function (node, next) { return "<table>" + next(node.content) + "</table>"; },
    _a[richTextTypes_es5_1.TABLE_ROW] = function (node, next) { return "<tr>" + next(node.content) + "</tr>"; },
    _a[richTextTypes_es5_1.TABLE_HEADER_CELL] = function (node, next) { return "<th>" + next(node.content) + "</th>"; },
...
var defaultMarkRenderers = (_b = {},
    _b[richTextTypes_es5_6.BOLD] = function (text) { return "<b>" + text + "</b>"; },
    _b[richTextTypes_es5_6.ITALIC] = function (text) { return "<i>" + text + "</i>"; },
    _b[richTextTypes_es5_6.UNDERLINE] = function (text) { return "<u>" + text + "</u>"; },
    _b[richTextTypes_es5_6.CODE] = function (text) { return "<code>" + text + "</code>"; },
    _b);
